...
function HomeBottomText() {
  return (
    <div className='font-[font2] flex items-center justify-center gap-2 '>
      <p className='absolute lg:w-[17vw] w-64 lg:right- right-0 bottom-28  lg:bottom-55 font-[font1] lg:text-s text-xs lg:leading-relaxed leading-tight'>
      ...
      <div className='lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50] lg:h-39 flex items-center px-3 pt-1 lg:px-14 border-white rounded-full uppercase'>
